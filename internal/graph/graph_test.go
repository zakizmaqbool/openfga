...
func TestConnectedObjectGraph_RelationshipIngresses(t *testing.T) {
	...
	tests := []struct {
		...
		// 	`,
		// 	target: typesystem.DirectRelationReference("repo", "reader"),
		...
		// },
		{
			...
			`,
			target: typesystem.DirectRelationReference("repo", "reader"),
			source: typesystem.DirectRelationReference("organization", "repo_admin"),
			expected: []*RelationshipIngress{
				{
					Type:             TupleToUsersetIngress,
					Ingress:          typesystem.DirectRelationReference("repo", "reader"),
					TuplesetRelation: typesystem.DirectRelationReference("repo", "owner"),
				},
			},
		},
		// {
		...
		// 		{
		// 			Type:    DirectIngress,
		// 			Ingress: typesystem.DirectRelationReference("organization", "member"),
		// 		},
		// 	},
		// },
	}
